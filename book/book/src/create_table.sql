...
create table tbl_book(
	...
	categoryid number references tbl_category(id),
	writer varchar2(30),
	publish varchar2(64),
	pages  number,
	images varchar2(100)
...
create sequence tbl_line_seq
increment by 1
start with 1
cache 5;


insert into tbl_category values(1,'计算机','计算机');
insert into tbl_category values(2,'英语','英语');
insert into tbl_category values(3,'自然科学','自然科学');

insert into tbl_book values(1,
					'JAVA编程思想：第3版',
