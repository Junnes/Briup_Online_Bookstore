...
<!--文件体开始-->
        ...
        <c:forEach items="${applicationScope.books }" var="book">
			<tr>
				...
				<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="productDetail?id=${book.id }">${book.name }</a></td>
				<td class=tablebody2 valign=middle align=center width="">${book.price }</td>
				<td class=tablebody1 valign=middle align=center width=""><a href="user/shopcartAdd?id=${book.id }">
