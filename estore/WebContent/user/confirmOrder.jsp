...
<!--文件尾开始-->
        ...
        <c:forEach items="${shoppingCart.lines }" var="entry">
			<tr>
				<td class=tablebody2 valign=middle align=center width="">${entry.value.book.id }</td>
				<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="user/productDetail?id=${entry.value.book.id }" target="_blank">${entry.value.book.name }</a></td>
